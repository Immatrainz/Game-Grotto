...
const GameModal = () => {
  ...
  useEffect(() => {
    if (Object.keys(clickedGame).length > 0) {
      ...
      setGameDetails({
        ...
        metacritic: 88,
        metacritic_platforms: [ [Object], [Object], [Object], [Object], [Object] ],
        released: '2021-03-26',
        tba: false,
        updated: '2023-04-20T01:29:14',
        background_image: 'https://media.rawg.io/media/games/d47/d479582ed0a46496ad34f65c7099d7e5.jpg',
        background_image_additional: 'https://media.rawg.io/media/screenshots/0da/0da98b6c57676f2f16cb6bf8818c8642.jpg',
        ...
        alternative_names: [],
        metacritic_url: 'https://www.metacritic.com/game/playstation-5/it-takes-two',
        parents_count: 0,
        additions_count: 1,
        game_series_count: 0,
        user_game: null,
  ...
  let getGameTrailers = () => {
    axios.get('/games/trailers', {params: {id: clickedGame.id}})
    .then(res => {
      console.log(res.data);
    ...
    <>
      ...
      >
        <div className='grid grid-cols-2'>
          <div>
            <h1 className='text-5xl h-20'>{gameDetails.name}</h1>
            <a href={gameDetails.website} target='_blank'>Link to Game Site</a>
            {gameDetails === {} ? <img className='game-modal-image object-contain' src={gameDetails.background_image}></img> : <video className='game-modal-image' src={gameTrailers.max} controls='controls' autoplay='true'/>}
          </div>
