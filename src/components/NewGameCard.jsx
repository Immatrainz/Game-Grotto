      ...
      <div className=' flex flex-col ml-5'>
        ...
        <div className='grid grid-cols-2 grid-rows-2 gap-2 mt-2 w-80'>
          {game.short_screenshots.slice(1).map(ss => {
            return (<div className='w-40 h-24' onMouseEnter={() => {setMainImage(ss.image)}} onMouseLeave={() => {setMainImage(game.background_image)}}><img className='w-40 h-24 object-cover object-center' src={ss.image}></img></div>)
          })}
        </div>
      </div>
    </div>
